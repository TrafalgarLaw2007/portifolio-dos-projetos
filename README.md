...
<body>
    <header class="container text-center">
        ...
        <p> E eu estou cursando o Ensino Médio. Ensino sobre pensamento computacional usando HTML, CSS e JavaScript e estou ultilizando o projeto da professora como base. Veja os projetos
            que já desenvolvi!</p>
